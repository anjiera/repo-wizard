...
* **Markdown-to-HTML Documentation Compiler**:
  - The zero-dependency helper utility [md-to-html.js](../solo-dev-toolkit/scripts/md-to-html.js) compiles standard Markdown documentation files into responsive HTML pages with native dark-mode stylesheet support:
    ```bash
