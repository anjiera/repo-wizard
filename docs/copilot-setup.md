...
3. Paste or link the contents of the agent persona you want to enforce. For example:
   ...
   [Copy and paste the instructions from repo-wizard/agents/legal-neutrality-agent.md]
   ```
...
2. Reference the skill file using `#file`:
   > *"Scan my file `strings.xml` for liability using `#file:legal-neutrality-scanner.md`"*
   > *"Give me 5 neutral alternatives for this wording based on the rules in `#file:legal-neutrality-agent.md` and `#file:legal-phrasing-dictionary.md`"*
