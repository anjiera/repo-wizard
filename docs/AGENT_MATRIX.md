...
| Technical Documentation Specialist | `technical-scribe` | 🟡 Yellow Team | `technical-scribe` | `/rw-technical-scribe` | [documentation-standards.md](../references/coding-standards/documentation-standards.md) | Audits and scaffolds ADR documentation systems and generates architecture flowcharts. |
