...
- Invoking the slash command: `/rw-observability-engineer`.
...
4. **Privacy Handoff Verification:** Verify that telemetry configurations implement context interceptors or span processors that scrub variables flagged by the `privacy-hardener` before trace/metric export.
