...
description: Guides agents through auditing and scaffolding security and compliance configurations (SOC 2 audit logging, ISO 27001 secure coding, FIPS crypto, IaC security scanning, signed commits). Use when checking compliance profiles, setting up security configurations, or audit logging.
---
...
* Establishing technical security controls for compliance certifications (SOC 2, ISO 27001, FIPS 140-2/3).
...
3. **Audit Logging Drafts:** Write templates or logging middleware configuration guides matching SOC 2 / ISO 27001 logging criteria.
...
- [ ] The developer's framework target (SOC 2, ISO 27001, FIPS) was interactively aligned.
...
- [ ] If SOC 2 or ISO 27001 is targeted, app logging configurations matching the CC6.1 audit trail requirements are drafted or scaffolded.
