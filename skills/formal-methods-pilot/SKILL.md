...
# Formal Verification & Specifications (`formal-methods-pilot`)
...
- Invoking the slash command: `/rw-formal-methods`.
...
- **Headless Mode Override:** Refer to Phase 3 of [Headless Mode Override Protocol](../../references/headless-override.md) (writing observations to `<reportRoot>/.repo-wizard/reports/<repo-name-here>/agents/<repo-name-here>-observations-formal-methods-pilot-agent.md`).
