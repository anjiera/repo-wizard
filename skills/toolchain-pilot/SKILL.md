...
# Cross-Compilation & Build Toolchains (`toolchain-pilot`)
...
- Invoking the slash command: `/rw-toolchain`.
...
- **Headless Mode Override:** Refer to Phase 3 of [Headless Mode Override Protocol](../../references/headless-override.md) (writing observations to `<reportRoot>/.repo-wizard/reports/<repo-name-here>/agents/<repo-name-here>-observations-toolchain-pilot-agent.md`).
