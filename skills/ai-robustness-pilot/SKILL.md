...
# AI Robustness & ML Governance Auditing and Scaffolding (`ai-robustness-pilot`)
...
- Invoking the slash command: `/rw-ai-robustness`.
...
- **Headless Mode Override:** Refer to Phase 3 of [Headless Mode Override Protocol](../../references/headless-override.md) (writing observations to `<reportRoot>/.repo-wizard/reports/<repo-name-here>/agents/<repo-name-here>-observations-ai-robustness-pilot-agent.md`).
