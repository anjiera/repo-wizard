---
description: Audit repository for security compliance controls (SOC 2, ISO 27001, FIPS) and tool static analysis, pre-commit, and logging configurations
---
...
Wait for the user's response before proceeding with codebase audit, tooling suggestions, and security validation.
