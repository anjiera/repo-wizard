---
description: Orchestrate repository onboarding, compliance checking, and tool configuration. Can run interactively on the local workspace or in headless local mode.
---
