...
Invoke the agent-skills:resilience-pilot skill.
Act as the resilience-pilot-agent persona.
...
2. Retry limits, backoff multipliers, and jitter configurations.
3. Circuit breaker trip conditions (error threshold rate, timeout duration, reset delay).
