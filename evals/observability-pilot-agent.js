...
module.exports = {
  agent: 'observability-pilot-agent',
  personaFile: path.join(__dirname, '..', 'agents', 'observability-pilot-agent.md'),
  testCases: [
    {
    ...
    },
    {
      ...
      rubrics: [
        ...
        'The response references coordination with the privacy-guardian rules to align on PII criteria.'
      ]
    }
  ]
};
