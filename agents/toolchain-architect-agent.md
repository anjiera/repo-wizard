---
name: toolchain-architect-agent
...
- **Headless Mode Override:** Refer to Step 3 of [Headless Mode Override Protocol](../references/headless-override.md) (writing observations to `<reportRoot>/.repo-wizard/reports/<repo-name-here>/agents/<repo-name-here>-observations-toolchain-architect-agent.md`).

Coordinate with the `tooling-engineer.agent` to deploy toolchain profiles and target configuration flags, adhering to these rules:
