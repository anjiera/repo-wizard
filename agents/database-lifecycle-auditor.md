...
For the step-by-step auditing checklist, alignment phases, scaffolding rules, verification tasks, and standard guidelines, you MUST load and follow the [paired Skill Workflow](../skills/database-lifecycle-auditor/SKILL.md). Do not duplicate or deviate from the skill instructions.
