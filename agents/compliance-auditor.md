...
For the step-by-step auditing checklist, alignment phases, tooling rules, verification tasks, and standard guidelines, you MUST load and follow the [paired Skill Workflow](../skills/compliance-auditor/SKILL.md). Do not duplicate or deviate from the skill instructions.
