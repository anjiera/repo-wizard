...
- **Headless Mode Override:** Refer to Step 3 of [Headless Mode Override Protocol](../references/headless-override.md) (writing observations to `<reportRoot>/.repo-wizard/reports/<repo-name-here>/agents/<repo-name-here>-observations-notebook-auditor-agent.md`).

Coordinate with the `tooling-engineer.agent` to deploy attributes files, notebook linters, and environment settings, adhering to these rules:
