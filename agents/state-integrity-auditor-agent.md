---
name: state-integrity-auditor-agent
...
- **Headless Mode Override:** Refer to Step 3 of [Headless Mode Override Protocol](../references/headless-override.md) (writing observations to `<reportRoot>/.repo-wizard/reports/<repo-name-here>/agents/<repo-name-here>-observations-state-integrity-auditor-agent.md`).

Coordinate with the `tooling-engineer.agent` to deploy formal specifications and verification harnesses, adhering to these rules:
