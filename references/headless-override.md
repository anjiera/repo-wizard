...
## Step 1 / Phase 1: Alignment & Target Stack
...
## Step 2 / Phase 2: Codebase Scan & Auditing
- Skip scanning consent prompts and proceed directly to scanning using the specified Approach (A or B).
- If **Approach B** (metadata-only) is active, enforce strict honest boundaries: output `[Data Blocked: Requires Shallow Clone / Local Checkout to evaluate]` for any unobservable details.

## Step 3 / Phase 3: Interactive Scaffolding Guidance
